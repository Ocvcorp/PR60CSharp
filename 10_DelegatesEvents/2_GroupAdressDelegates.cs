...
{
    delegate void DelCalc(double x, ref double y);

    public class YCalc
    {
        public void Plus(double x, ref double y)
        {
            y += x;
        }
        public void Minus(double x, ref double y)
        {
            y -= x;
        }
        public void Multi(double x, ref double y)
        {
            y *= x;
        }
        public void Devide(double x, ref double y)
        {
            y = x/y;
        }
        public void Pow(double x, ref double y)
        {
            y = Math.Pow(y,x);
        }
        //static methods
        public static void StatPlus(double x, ref double y)
        {
            y += x;
        }
        public static void StatMinus(double x, ref double y)
        {
            y -= x;
        }
        public static void StatMulti(double x, ref double y)
        {
            y *= x;
        }
        public static void StatDevide(double x, ref double y)
        {
            y = x / y;
        }
        public static void StatPow(double x, ref double y)
        {
            y = Math.Pow(y, x);
        }
    }
